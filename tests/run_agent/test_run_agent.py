...
def test_aiagent_uses_opencode_acp_client():
    ...
    assert mock_acp_client.call_args.kwargs["command"] == "/home/user/opencode"
    assert mock_acp_client.call_args.kwargs["args"] == ["acp", "--cwd", "/tmp/repo"]
